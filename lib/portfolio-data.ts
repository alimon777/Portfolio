    ...
    projects: [
      {
        ...
        badgeIcon: "extension",
        desc: "A VS Code extension with a built-in MCP server that turns your GitHub repo into a structured library of AI instruction skills. ",
        tags: ["TYPESCRIPT", "MCP", "GITHUB API"],
